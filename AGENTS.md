...
| Plan de verificación del sistema | `Docs/verification.md` | Primero **qué puede salir mal**: 23 modos de fallo `MF-01`…`MF-23` sobre las rejillas de MAST, ConStory-Bench y los fallos silenciosos, con 9 sin validador. Después **cómo se detecta**: 45 validadores `VER-01`…`VER-46`, cada uno con su punto ciego, más los 8 asumidos y lo que se aprendió al escribir cinco. Ninguno implementado hoy |
