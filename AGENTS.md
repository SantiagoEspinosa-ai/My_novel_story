...
| Specs en curso | `specs/` | Un fichero por spec. Hoy `SPEC-01` backend del harness (**`aprobada`**), `SPEC-09` versión de `Resumen`, `SPEC-12` formas reducidas del recorte, las dos en `en_revision`. `SPEC-11` está **reservada** para los cinco huecos de arquitectura que inventarió `SPEC-10` |
