...
| Specs | `specs/` | Un fichero por spec, sin carpetas anidadas. Hoy: `SPEC-01` backend (`en_revision`), `SPEC-03` referencias del dominio (`aplicada`) y `SPEC-04` puerta de capítulo y reclasificaciones (`en_revision`). `SPEC-02`, vocabularios, se aplicó y su fichero se retiró |
