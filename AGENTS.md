...
| Specs en curso | `specs/` | Un fichero por spec. Hoy `SPEC-01` backend del harness (**`aprobada`**), y en `en_revision` `SPEC-09` versión de `Resumen` y `SPEC-15` lo que declara el plan |
