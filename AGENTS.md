...
| Specs en curso | `specs/` | Un fichero por spec. Hoy `SPEC-01` backend del harness (**`aprobada`**), `SPEC-09` versión de `Resumen` y `SPEC-10` huecos que la rama `main` ya sufrió, las dos últimas en `en_revision` |
