...
| Specs en curso | `specs/` | Un fichero por spec. Hoy `SPEC-01` backend del harness (**`aprobada`**) y `SPEC-09` versión de `Resumen`. `SPEC-09` sigue en `en_revision`. `SPEC-11` observabilidad del pipeline, también en `en_revision` |
