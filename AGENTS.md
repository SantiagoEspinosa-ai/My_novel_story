...
| Specs en curso | `specs/` | Un fichero por spec. Hoy `SPEC-01` backend del harness, `SPEC-05` caducidad de las afirmaciones condicionales y `SPEC-06` estructura de `harness/`, las tres en `en_revision` |
