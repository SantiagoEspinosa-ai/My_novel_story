...
- `harness/documentos/` — una de las tres carpetas que declara `docs/architecture.md` § "El harness". Las otras dos, `harness/evals/` y `harness/adversarial/`, ya existen y tienen su fila arriba. Se escribieron cinco validadores a modo de prueba y se retiraron; lo que enseñaron está en `docs/verification.md` § "Lo que se aprendió al implementar".
