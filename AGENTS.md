...
| Skills del proyecto | `myFactory/skills/` | Contenido real de las ocho skills instaladas, un `PROCEDENCIA.md` en cada una (repositorio, commit y fecha), y en su `README.md` cuándo usar cada una |
