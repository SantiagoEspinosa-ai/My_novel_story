...
| **EX-09** | § "Novela de ejemplo" `:132`: *«Si el formato de lectura elegido es web, se incluye igualmente el PDF exportado»* | `SPEC-22` §1.2, fila *«Publicar la obra a un formato de libro»* en **No entra** (`:85`). `SPEC-22` está `aprobada` | Contradicción | **Bloqueante. Decidido (2026-09-23)**: una spec corta para exportar a PDF, que corrige de paso esa fila de `SPEC-22` en vez de reabrir entera una spec aprobada. **Necesita spec** |
