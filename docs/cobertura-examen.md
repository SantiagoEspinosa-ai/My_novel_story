...
**Bloqueantes al cerrar la vuelta 2**: `EX-04` (espera a la lectura web), `EX-07` (de la
sesión de TLA+), `EX-11` (los seis documentos de proceso, sin nada que decidir: es trabajo
de documentación), `EX-16` y `EX-17` (esperan decisión).
