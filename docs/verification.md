...
| | |
| --- | --- |
| **Modos de fallo catalogados** | **27 vigentes** (`MF-01`…`MF-28`, con `MF-25` retirado por `SPEC-14`: dejó de ser posible). **`MF-26` es el único que no tiene nadie mirando**; `MF-27` y `MF-28` nacieron cerrados el mismo día en que se catalogaron, los dos por `procedencia.py` |
