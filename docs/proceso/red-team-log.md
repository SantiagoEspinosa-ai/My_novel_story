...
| **Los hooks no se cargaron** (`F-61`) | La primera ejecución real | Nadie en el momento: no dejaron constancia | Diagnosticado —Claude Code solo los carga desde la raíz del repositorio— y **cerrado** en `1ad5691`: las delegaciones arrancan en la raíz, y en la segunda ejecución real los hooks ya dejan constancia. Las puertas del código siguen mandando |
