...
| `INV-22` nombres exactos | Programático, `bloqueante` | Tras el Escritor, antes del Editor | Reescritura, tope 2; agotado, se para | **Sí, con toda probabilidad en falso**: no deja rastro en el audit log (`F-73`). Con el arreglo de `F-71`, dos de los tres borradores reales quedan limpios y el tercero sigue dando positivo por «Nadie» |
